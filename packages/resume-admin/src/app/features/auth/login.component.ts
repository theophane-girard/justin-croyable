      ...
      @if (signingIn()) {
        ...
        <app-card class="w-full max-w-sm">
          <div class="flex flex-col items-center gap-6 p-6 text-center">
            ...
            >
              <ng-icon name="phosphorIdentificationCard" class="size-7" />
            </div>
            <div class="flex flex-col gap-1">
              <h1 class="text-xl font-semibold">Administration du CV</h1>
              <p class="text-muted-foreground text-sm">
                Connecte-toi avec le compte Google autorisé pour modifier tes informations.
              </p>
            </div>
