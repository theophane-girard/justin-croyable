...
export type BadgeTypeVariants = NonNullable<VariantProps<typeof badgeVariants>['type']>;
export type BadgeShapeVariants = NonNullable<VariantProps<typeof badgeVariants>['shape']>;
