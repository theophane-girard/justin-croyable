...
export const buttonVariants = cva(
  mergeClasses(
    ...
    // Le curseur n'a pas besoin d'être neutralisé pour disabled / loading : ces
    // deux états posent `pointer-events-none`, donc l'élément ne reçoit plus le
    // survol et c'est le curseur du parent qui s'applique.
    'cursor-pointer',
  ),
  {
    variants: {
...
export type ButtonVariant = NonNullable<VariantProps<typeof buttonVariants>['type']>;
