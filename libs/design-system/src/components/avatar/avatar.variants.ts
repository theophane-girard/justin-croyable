...
export type AvatarSizeVariants = NonNullable<VariantProps<typeof avatarVariants>['size']>;
export type AvatarGroupOrientationVariants = NonNullable<VariantProps<typeof avatarGroupVariants>['orientation']>;
