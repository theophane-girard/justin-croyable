...
import { loaderVariants, type LoaderVariants } from './loader.variants';
...
export class LoaderComponent {
  ...
  readonly size = input<LoaderVariants['size']>('default');
  ...
  protected readonly classes = computed(() =>
    mergeClasses(loaderVariants({ size: this.size() }), this.class()),
  );
}
